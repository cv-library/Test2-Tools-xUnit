...
using table-driven tests as in this example:
 ...
 sub square_root_of_perfect_square : Test {
     ...
     while (my ($square, $root) = each %squares) {
         my $result = sqrt(4);
         is $result, 2, "should return $root as root of $square";
     }
 }
...
was thrown unexpectedly - in fact you need to be finding out why an exception
was not thrown:

 not ok 1 - square_root_of_negative_square {
     not ok 1 - throws exception with error message
     1..1
 }
